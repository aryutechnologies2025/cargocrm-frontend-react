  ...
  return (
    <div className="p-4 gap-3 w-full min-h-screen bg-white rounded-xl shadow">
      ...
      <form onSubmit={handleSubmit} className="gap-3 flex flex-col w-full bg-white rounded-xl shadow p-6">
        ...
        {/* Buttons */}
        <div className="flex justify-end gap-4 mt-6 bg-white p-4">
          <button
            type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="px-6 py-2 rounded-lg bg-[#057fc4] text-white hover:bg-[#046aa4] disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
          >
            {loading ? (
